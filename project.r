rm(list=ls(all=T))
setwd("C:\\Users\\Deepak Jaiswal\\Desktop\\EdvisorProject\\project.r")
...
bike = read.csv("C:\\Users\\Deepak Jaiswal\\Desktop\\EdvisorProject\\day.csv", header = T, na.strings = c(" ", "", "NA"))
